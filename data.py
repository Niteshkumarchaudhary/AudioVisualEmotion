...
class DataSet():
    ...
    def __init__(self, seq_length=40, class_limit=None, image_shape=(299, 299, 3)):
        ...
        self.sequence_path = os.path.join('/data/niteshku001/Ravdess/data', 'sequences')
    ...
    def split_train_test(self):
        ...
        for item in self.data:
            ...
            if item[0] == 'train1':
            #if item[0] == 'train':
            #if item[0] == 'train_data_labelled_video_ravdess':
                train.append(item)
            else:
                test.append(item)
        return train, test
    ...
    def get_frames_for_sample(sample):
        ...
        filenames."""
        path = os.path.join('/data/niteshku001/Ravdess/data', sample[0], sample[1])
        filename = sample[2]
    ...
    def rescale_list(input_list, size):
        ...
        #print("rescaled size: ", np.array(output).shape)
